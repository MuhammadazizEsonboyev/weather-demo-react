...
const weather = require("../src/image/icon.png")
...
function App() {
  ...
  return (
    <>
      <Container>
        <Row className=" justify-content-center mt-5 ">
          <Col xs={4} className="d-none d-lg-block ">
            <input type="text" value={value} placeholder="Search Location" onChange={(e) => setValue(e.target.value)} />
       ...
       {!data ? 
        ...
        <Col xs={10} lg={4}>
          <div className="card-weather">
            <h1>None</h1>
            <h3>None</h3>
            <img className="image-weather" src={weather} alt="none" />
      ...
      </Row> :  <Row className="justify-content-center mt-2">
          <Col xs={10} lg={4}>
            <div className="card-weather">
              <h1>{data?.name}</h1>
